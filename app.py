...
if user_input:
    ...
    # şimdilik sabit bir bot cevabı (Perşembe günü Meryem'in RAG'ı buraya bağlanacak)
    sabit_cevap = "Bu özelliği yakında ekip arkadaşım Meryem ile birlikte aktif hale getireceğiz! 🔧"
